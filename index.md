...
hero:
  text: "Modular Commerce Orchestration for Laravel"
  tagline: "A flexible and decoupled ecosystem to streamline revenue management. Whether you need payment processing, subscription management, or a full custom commerce build, Payavel provides the modular tools to make it happen."
  image:
    src: /icon-color-no_background.svg
    alt: Payavel Icon
  actions:
    - theme: brand
      text: Get Started
