...
Upon initializing orchestration using the [setup wizard](./getting-started#setup-wizard), a 'config/orchestration.php' file is created. This serves as your global configuration, applying default settings across all services unless overridden by service-specific configurations.
